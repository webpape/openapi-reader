...
class UOpenApi {
   ...
   static findRefs(object: any, openapiDocument: openapiDocument | undefined, counter = 0): any {
      if (counter >= 20) return object
      ...
      for (const key in object) {
         if (object.hasOwnProperty(key)) {
            ...
            object[key] = this.findRefs(value, openapiDocument, counter + 1)
         }
      }
